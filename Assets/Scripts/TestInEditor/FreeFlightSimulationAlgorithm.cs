...
namespace WASVPS
{
    public class FreeFlightSimulationAlgorithm : MonoBehaviour, IWASVPSLocalisationAlgorithm
    {
        private VPSLocalisationService localisationService;
        private ServiceProvider provider;
        
        private SettingsWASVPS settings;
        ...
        public void SetSettings(SettingsWASVPS settings)
        {
        ...
        public bool CheckTakePhotoConditions(Vector3 curAngle, SettingsWASVPS settings)
        {
